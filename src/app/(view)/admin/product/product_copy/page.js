...
const CopyProduct = ({ id }) => {
    ...
    const [productData, setproductData] = useState({
        ...
        product_name: '', status_id: '', file_path: '', product_description: '', brand_id: '', model_id: '', category_id: '', sub_category_id: '', period_id: '', unit_id: '', warranty_id: '', material_id: '', color_id: '', type_id: '', product_price: '', product_weight: '', file_s: '', file_m: '', file_ms: ''
    });
    ...
    const product_create = (event) => {
        ...
        const addValue = {
            ...
            category_id, sub_category_id, period_id, unit_id, warranty_id, material_id, color_id,
            type_id, product_price, file_path, file_s, file_ms, file_m, product_weight
