...
const ProductQuickEntry = () => {
    ...
    const [fields, setFields] = useState([{
        product_name: '', product_brand_id: '', product_category_id: '', product_status: '', file_path: '', product_description: '', product_brand: '', product_model: '', product_category: '', product_sub_category: '', product_period: '', product_unit: '', product_warranty: '', product_material: '', product_color: '', product_type: '',
        product_price: '', product_weight: '', created_by: created
    }]);
    ...
    const update_fields = (index, event) => {
        ...
        const warrantyNames = newFields[index]['product_warranty'];
        if (warrantyNames) {
    ...
    const handleAddMore = () => {
        ...
        if (!isNaN(numToAddInt) && numToAddInt > 0) {
            ...
            for (let i = 0; i < numToAddInt; i++) {
                newInputValues.push({
                    product_name: '', product_brand_id: '', product_category_id: '', product_status: '', file_path: '', product_description: '', product_brand: '', product_model: '', product_category: '', product_sub_category: '', product_period: '', product_unit: '', product_warranty: '', product_material: '', product_color: '', product_type: '', product_price: '', product_weight: '',
                    created_by: created
                });
            }
...
const router = useRouter()
    ...
    const quick_product_entry = (event) => {
        ...
        if (!handleValidation('product_warranty', 'Please Enter a Warranty.', setWarrantyName)) return;
    ...
    //     sheet.getColumn('product_warranty').numFmt = '0';
    ...
    const exportExcelFile = () => {
        ...
        let column_header = [
            ...
            { header: "Product Warranty", key: "product_warranty", width: 25 },
