        ...
        try {
            ...
            for (const single_object of req.body) {
                ...
                const insert_product = await new Promise((resolve, reject) => {
                    connection.query(`INSERT INTO product (product_name, status_id, created_by, product_price, product_description, product_weight) VALUES (?,?,?,?,?,?);`, [product_name, product_status_id, created_by, product_price, product_description, product_weight], (error, result) => {
            ...
            connection.beginTransaction(err => {
                ...
                productData.product_description,
                    productId], (err, result) => {
                        ...
                        const updateQueries = [
                            `UPDATE product_brand SET brand_id = ${productData.brand_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_model SET model_id = ${productData.model_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_category SET category_id = ${productData.category_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_sub_category SET sub_category_id = ${productData.sub_category_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_period SET period_id = ${productData.period_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_unit SET unit_id = ${productData.unit_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_warranty SET warranty_id = ${productData.warranty_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_material SET material_id = ${productData.material_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_color SET color_id = ${productData.color_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
                            `UPDATE product_type SET type_id = ${productData.type_id}, created_by = '${productData.created_by}' WHERE product_id = ${productId}`,
